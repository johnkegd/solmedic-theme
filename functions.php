...
function machic_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            'name'                  => esc_html__('WooCommerce Wishlist','machic'),
            'slug'                  => 'ti-woocommerce-wishlist',
        ),
		
		array(
            'name'                  => esc_html__('WooCommerce Compare','machic'),
		...
		array(
            'name'                  => esc_html__('Variation Swatches','machic'),
            'slug'                  => 'woo-variation-swatches',
        ),

		array(
            'name'                  => esc_html__('WP Ajax Search','machic'),
