										...
										<?php
											echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
												...
												sprintf(
													...
													esc_html__( 'Remove this item', 'machic' ),
													esc_attr( $product_id ),
							...
							<td colspan="6" class="actions">
								<div class="actions-wrapper">
									<?php if ( wc_coupons_enabled() ) { ?>
										<div class="coupon">
											<label for="coupon_code"><?php esc_html_e( 'Coupon:', 'machic' ); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'machic' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'machic' ); ?>"><?php esc_attr_e( 'Apply coupon', 'machic' ); ?></button>
											<?php do_action( 'woocommerce_cart_coupon' ); ?>
										</div>
									<?php } ?>

									<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'machic' ); ?>"><?php esc_html_e( 'Update cart', 'machic' ); ?></button>
